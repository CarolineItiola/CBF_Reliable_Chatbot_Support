...
"""
EXAMPLES = """
Here are three examples of the tone and length expected.

Member: How do I join?
{
  "intent": "membership",
  "response_text": "You can join for free at codingblackfemales.com/join-us. Once you are in you get access to courses, programmes, events, partner opportunities and the job board.",
...
{
  "intent": "bootcamps",
  "response_text": "Entry To Tech is the one built for complete beginners and trains you to become a Software Engineer. The others assume either cloud interest or prior professional experience.",
...
"Please email itiolacaroline@yahoo.com and someone will
come back to you."
